...
#-122.4395< longitude <  -122.413
# 37.723< lattitude <37.752
class Point(object):
    '''
...
for index,row in emp_addresses.iterrows():
        if row['longitudes']< -122.413 and row['longitudes']>-122.4395 and row['lattitudes']<37.752 and row['lattitudes']>37.723:
            tmp=[]
...
gmap.draw("section2_4_stops.html")