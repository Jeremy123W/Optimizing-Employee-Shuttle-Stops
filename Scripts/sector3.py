...
for index,row in emp_addresses.iterrows():
        if row['longitudes']< -122.426 and row['longitudes']>-122.455 and row['lattitudes']<37.724 and row['lattitudes']>37.7:
            tmp=[]
...
total_distances=[]
bus_combinations=[]
for combination in itertools.combinations(bus_stop,3):
    distance=0
...
gmap.draw("section3_3_stops.html")